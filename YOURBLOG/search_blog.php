...
if(isset($_POST["query"])) {
	...
	$query = "SELECT id_blog,titolo,autore,descrizione,data_blog,immagine,username,Categoria.nomeC FROM Blog,Categoria,Utente WHERE Blog.categoria = Categoria.id_categoria and Blog.autore = Utente.id_utente and titolo LIKE '%".$search."%'";
